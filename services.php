      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 mb-4">
            ...
            <div class="pt-4">
              <ul>
                <li>Mixes international students with local students from local Universities</li>
                <li>Focuses on cultural and educational exchange.</li>
                <i>
                  <h6>
                    <a href="#">Educational Visits and Activities</a>
                  </h6>
                </i>
                <li>Visits to relevant learning institutions (factories, industrial zones, service providers).</li>
                <li>Includes games and fun stories to enhance learning.</li>
                <i>
                  <h6>
                    <a href="#">International Internship Programs</a>
                  </h6>
                </i>
                <li>Hands-on experience in various industries.</li>
                <li>Enhances employability and professional growth.</li>
                <i>
                  <h6>
                    <a href="#">Sober Trips</a>
                  </h6>
                </i>
                <li>Exclusive travel experiences for Sober Club members</li>
                <li>Explore tourist areas in Rwanda and beyond (lakes, forests, parks, volcanoes).</li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-6 mb-4">
            <div class="d-flex flex-column align-items-center">
              ...
              <!-- <div class="mb-3">
                <img src="assets/img/Picture3.jpg" class="img-fluid" alt="Image 3">
